...
class OrderApproved extends Notification
{
    ...
    {
        $formattedDate = Carbon::parse($this->order->approval_time)
            ->setTimezone('Asia/Kolkata') // change timezone as needed
        ...
        return (new MailMessage)
            ...
            ->line("Your order [#{$this->order->order_number}] has been approved on {$formattedDate}.")
    ...
    public function toArray($notifiable): array
    {
        ...
        return [
            ...
            'message' => "Your order [#{$this->order->order_number}] has been approved on {$formattedDate}.",
