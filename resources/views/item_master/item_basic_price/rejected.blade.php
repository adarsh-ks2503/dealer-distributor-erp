...
@section('title', 'Item Basic Prices Rejected Requests - Singhal')
...
@section('content')
    <main id="main" class="main">
        ...
        <div class="dashboard-header pagetitle">
            <h1>Item Basic Prices Rejected Requests</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Item Master</a></li>
                    <li class="breadcrumb-item active">Item Basic Prices Rejected Requests</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                        ...
                        <div class="card-body mt-4">
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="pd-20">
                                        <h4 class="text-blue h4">Item Basic Prices Rejected Requests</h4>
                                    </div>
                                </div>
...
<div>
    <button class="btn btn-danger mb-4 mx-1 reject-all-btn">
        Reject All
                            ...
                            <table class="display stripe row-border order-column" id="item_basic_price_rejected_table" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>ITEM</th>
