...
@section('title', 'Item Sizes Approval - Singhal')
@section('content')
    <main id="main" class="main">
        ...
        <div class="dashboard-header pagetitle">
            <h1>Item Sizes Approval Requests</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Item Master</a></li>
                    <li class="breadcrumb-item">Item Sizes Approval Requests</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                        ...
                        <div class="card-body mt-4">
                            ...
                            <div class="row ">
                                <div class="col-md-6 col-sm-12">
                                    <div class="pd-20">
                                        <h4 class="text-blue h4">Item Sizes Approval Requests</h4>
                                    </div>
                                </div>
                            ...
                            <table class="display stripe row-border order-column" id="item_basic_price_table" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>ITEM</th>
                                        <th class="text__left">SIZE</th>
                                        <th class="text__left">RATE</th>
                                        <th class="text__left">HSN CODE</th>
                                ...
                                <tbody>
                                    @foreach ($requests as $i=>$item)
                                        <tr>
                                            ...
                                            <td class="text__left">{{ $item->size }}</td>
                                            <td class="text__left">{{ $item->rate }}</td>
                                            <td class="text__left">{{ $item->hsn_code }}</td>
                                            <td class="text__left">{{ $item->remarks }}</td>
                                            <td class="text__left">{{ $item->status }}</td>
                                                    ...
                                                    <ul class="dropdown-menu custom-dropdown-menu" aria-labelledby="actionMenu{{ $item->id }}">
                                                        <li>
                                                            <button class="dropdown-item approve-btn"
                                                                    data-id="{{ $item->id }}"
                                                                    data-url="{{ route('itemSizes.approve', $item->id) }}">
                                                        ...
                                                        @if ($item->status === 'Pending')
                                                            <li>
                                                                <button class="dropdown-item reject-btn"
                                                                        data-id="{{ $item->id }}"
                                                                        data-url="{{ route('itemSizes.reject', $item->id) }}">
            ...
            <form id="approveForm" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Are you sure you want to <strong>approve</strong> this Item Size-Rate request?
                    </div>
        ...
        <div class="modal-dialog">
            <form id="rejectForm" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Are you sure you want to <strong>reject</strong> this Item Size-Rate request?
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
