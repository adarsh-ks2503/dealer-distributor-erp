...
<main id="main" class="main">
    <div class="dashboard-header pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('distributors.index') }}">Dealers</a></li>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="mobile_no" class="form-control custom-input" placeholder="Mobile No. Number" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Dealer Type:</label>
    ...
    <script>
            ...
            function attachment_add_Row_1(event) {
                ...
                cell2.innerHTML =
                    `<input type="number" name="contact_person[${index}][mobile_no]" class="form-control">`;
