    ...
    <section class="section">
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="mb-0 fw-bold">New Dealer</h4>
...
<script>
    ...
    function addContactRow(event) {
        ...
        td1.innerHTML = `<input type="text" name="contact_person[${index}][name]" class="form-control custom-input" placeholder="Enter Name" >`;
        row.appendChild(td1);

        const td2 = document.createElement('td');
        td2.innerHTML = `<input type="text" name="contact_person[${index}][mobile_no]" class="form-control custom-input" placeholder="10-digit Mobile Number" pattern="\\d{10}" maxlength="10" minlength="10" inputmode="numeric" >`;
        row.appendChild(td2);

        const td3 = document.createElement('td');
        td3.innerHTML = `<input type="email" name="contact_person[${index}][email]" class="form-control custom-input" placeholder="Enter Email">`;
        row.appendChild(td3);

        const td4 = document.createElement('td');
        let actionButtons = `<button type="button" onclick="addContactRow(event)" class="btn btn-success"><i class="fas fa-plus-circle"></i></button>`;
        actionButtons += ` <button type="button" onclick="deleteRow(this)" class="btn btn-danger ms-2"><i class="fas fa-minus-circle"></i></button>`;
        td4.innerHTML = actionButtons;
        row.appendChild(td4);
    ...
    $(document).ready(function() {
        ...
        // State / City AJAX logic (load cities based on state, preserve old city)
        ...
        // Trigger state change on page load if old state_id exists
        @if(old('state_id'))
