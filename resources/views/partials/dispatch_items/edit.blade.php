...
<div class="card mb-4">
    ...
    <div class="card-body table-responsive">
        <table class="table">
            ...
            <tfoot>
                <tr>
                    ...
                    <td><input type="number" name="total__dis_quantity" class="form-control"
                            value="{{ $dispatch->total__dis_quantity }}" id="total__dis_quantity" readonly></td>
                    <td></td>
                    <td> </td>
                    <td></td>
                    <td></td>
                    ...
                    <td>
                        <input type="number" name="total_amount" class="form-control"
                            value="{{ $dispatch->total_amount }}" id="total__basic_amount" readonly>
                    </td>
        ...
        <script>
            ...
            @include('partials.dispatch_items.edit_fetch_row')
...
<script>
    ...
    // Function for check item quantity
    // function check_item_qty(val, lastItemId) {
    //     let item_qty = parseFloat($(`#sauda_item_quantity__${lastItemId}`).val());
    //     if (val > item_qty) {
    //         Swal.fire({
    //             icon: 'warning',
    //             title: 'Oops!',
    //             text: `Dispatch quantity exceeded — maximum allowed is: ${item_qty}`,
    //             confirmButtonText: 'Ok',
    //             reverseButtons: true
    //         });
    ...
    function check_group_qty(lastItemId) {
        ...
        if (item_totalGroupQty > group_Qty) {
            Swal.fire({
                icon: 'warning',
                title: 'Oops!',
                text: `Group "${selectedGroup}" quantity exceeded. Allowed limit: ${group_Qty}`,
            }).then(() => {
